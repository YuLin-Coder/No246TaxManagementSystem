            ...
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/global.js"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/jquery.tab.js"></script>
                    ...
                    <div style="width:720px;">  <input type="text" class="inpMain" style="color:black;width:500px;" value="${data.title}" placeholder="请输入标题" id="title" />	<span style="color:red">*必填</span>
                        ...
                        <td >
                        <div style="width:720px;">  <input type="text" class="inpMain" style="color:black;width:500px;" value="${data.wgType}" placeholder="请输入违规类型" id="wgType" />	<span style="color:red">*必填</span>
                            </div>
                            </td>
                            </tr>
                            ...
                            <td >
                            <div style="width:720px;">  <textarea  placeholder="请输入违规详情"  id="wgDetail"  rows="15" cols="100">${data.wgDetail}</textarea>	<span style="color:red">*必填</span>
                                </div>
                                </td>
                                </tr>
                                ...
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                    ...
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0069"></script>
                                        ...
                                        function submitData(){
                                            ...
                                            $.ajax({
                                                type: 'post',
                                                url: '${pageContext.request.contextPath}/admin/wg_info/update_submit',
                                                    data:{
                                                        "id":'${data.id}',
