    ...
    <link href="${pageContext.request.contextPath}/static/admin/css/public.css" rel="stylesheet" type="text/css">
        <link href="${pageContext.request.contextPath}/static/admin/css/modal_css.css" rel="stylesheet" type="text/css">
            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                ...
                <a href="${pageContext.request.contextPath}/admin/notice_info/add" class="btnGreen">新增</a>
                    ...
                    <div id="notice_info_bar" class="pagination" style="margin-top:20px;"></div>
                    ...
                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/modal_js.js"></script>
                                ...
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1980"></script>
                                                ...
                                                url : "${pageContext.request.contextPath}/admin/notice_info/queryList",
                                                    ...
                                                    success : function(result) {
                                                        ...
                                                        for (var i = 0; i < rows.length; i++) {
                                                            ...
                                                            html+='<td>';
                                                            html+='<a href="${pageContext.request.contextPath}/admin/notice_info/update?id='+rows[i].noticeInfo.id+'" class="btn btnStyle">修改</a>';
                                                                html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].noticeInfo.id+'" class="btnPayment btnStyle">删除</a>';
                                                                html+='</td>';
                                                                html+='</tr>';
                                                            }
                                                            if (rows.length == 0) {
