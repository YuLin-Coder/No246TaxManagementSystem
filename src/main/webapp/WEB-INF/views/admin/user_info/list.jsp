                        ...
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/modal_js.js"></script>
                                    ...
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0718"></script>
                                                            ...
                                                            url : "${pageContext.request.contextPath}/admin/user_info/queryList",
                                                                ...
                                                                success : function(result) {
                                                                    ...
                                                                    for (var i = 0; i < rows.length; i++) {
                                                                        ...
                                                                        var idNumberVal=setNullToEmpty(rows[i].userInfo.idNumber);
                                                                        html+='<td>'+ idNumberVal+'</td>';
                                                                        var emailVal=setNullToEmpty(rows[i].userInfo.email);
                                                                        html+='<td>'+ emailVal+'</td>';
                                                                        var cityIdVal=setNullToEmpty(rows[i].cityIdStr);
                                                                        html+='<td>'+ cityIdVal+'</td>';
                                                                        var addressVal=setNullToEmpty(rows[i].userInfo.address);
