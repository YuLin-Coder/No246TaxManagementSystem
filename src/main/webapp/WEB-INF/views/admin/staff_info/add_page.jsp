        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/jquery.min.js"></script>
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/global.js"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/jquery.tab.js"></script>
                    ...
                    <tr  id="loginNameParentContent">
                    <td align="right">登录名</td>
                    <td >
                    <div style="width:720px;">  <input type="text" class="inpMain" style="color:black;width:500px;"  placeholder="请输入登录名" id="loginName" />	<span style="color:red">*必填</span>
                    </div>
                    </td>
                    </tr>
                    
                    <tr  id="passwordParentContent">
                    <td align="right">密码</td>
                    <td >
                    <div style="width:720px;">  <input type="text" class="inpMain" style="color:black;width:500px;"  placeholder="请输入密码" id="password" />	<span style="color:red">*必填</span>
                    </div>
                    </td>
                    </tr>
                    ...
                    <td >
                    <div style="width:720px;">  <input type="text" class="inpMain" style="color:black;width:500px;"  placeholder="请输入姓名" id="realName" />	<span style="color:red">*必填</span>
                    </div>
                    </td>
                    </tr>
                    ...
                    <td >
                    <div style="width:720px;">  <input type="text" class="inpMain" style="color:black;width:500px;"  placeholder="请输入身份证号码" id="idNumber" />	<span style="color:red">*必填</span>
                    </div>
                    </td>
                    </tr>
                    ...
                    <c:forEach items="${cityInfoList}" var="item">
                        <option value="${item.id}">${item.name}</option>
                            ...
                            <td >
                            <div style="width:720px;">  <input type="text" class="inpMain" style="color:black;width:500px;"  placeholder="请输入地址" id="address" />	<span style="color:red">*必填</span>
                            </div>
                            </td>
                            </tr>
                                    ...
                                    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/selectSearch/jquery.searchableSelect.css?d=129339" />
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/selectSearch/jquery.searchableSelect.js?d=1293393"></script>
                                            ...
                                            function submitData(){
                                                ...
                                                $.ajax({
                                                    type: 'post',
                                                    url: '${pageContext.request.contextPath}/admin/staff_info/add_submit',
                                                        data:{
