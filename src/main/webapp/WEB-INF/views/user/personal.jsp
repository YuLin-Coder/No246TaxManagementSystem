            ...
            <th width="90%"  >${detail.userInfo.loginName}</th>
                ...
                <th width="90%"  >${detail.userInfo.realName}</th>
                    ...
                    <th width="90%"  >${detail.userInfo.celPhone}</th>
                        ...
                        <th width="90%"  >${detail.userInfo.idNumber}</th>
                            </tr>
                            <tr>
                            <th width="10%">邮箱</th>
                            <th width="90%"  >${detail.userInfo.email}</th>
                                </tr>
                                <tr>
                                <th width="10%">城市</th>
                                <th width="90%"   id=cityIdStr>${detail.cityIdStr}</th>
                                    ...
                                    <tr>
                                    <th width="10%">地址</th>
                                    <th width="90%"  >${detail.userInfo.address}</th>
                                        </tr>
                                        <tr>
                                        <th width="10%">注册时间</th>
                                        <th width="90%"  >${detail.userInfo.createTime}</th>
                                            ...
                                            <div class="action">
                                            <a href="${pageContext.request.contextPath}/user/user_info/update?id=${detail.userInfo.id}" class="btn">修改</a>
                                                </div>
