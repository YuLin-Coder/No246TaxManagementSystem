    ...
    <div class="layui-col-md12">
      ...
      <div class="layui-row">
        <div class="layui-col-xs6 layui-col-sm6 layui-col-md6" style="padding:6px;">
    		<label class="layui-form-label">搜索公告</label>
      ...
      <div class="fly-panel" style="margin-bottom: 0;">
         <div class="fly-panel-title fly-filter">
           <a href="javascript:void(0)"  class="typeClass2 layui-this">公告查询</a>
  	...
  	$.ajax({
  				...
  				success : function(result) {
  					...
  					for (var i = 0; i < rows.length; i++) {
   		              		html+=' <li>';
	html+='<h2>';
	html+=' <a href="${pageContext.request.contextPath}/notice/detail?id='+rows[i].t.id+'">'+rows[i].t.title+'</a>';
	html+=' </h2>';
