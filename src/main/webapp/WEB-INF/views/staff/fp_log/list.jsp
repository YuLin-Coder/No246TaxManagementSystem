                        ...
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/modal_js.js"></script>
                                    ...
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=5227"></script>
                                        ...
                                        function ajaxList(page) {
                                            ...
                                            showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                $.ajax({
                                                    type : 'get',
                                                    url : "${pageContext.request.contextPath}/staff/fp_log/queryList",
                                                        data : {
                                                        ...
                                                        success : function(result) {
                                                            ...
                                                            for (var i = 0; i < rows.length; i++) {
                                                                ...
                                                                if(zjImgStr!=null){
                                                                    ...
                                                                    html+='<td>';
                                                                    if(rows[i].fpLog.checkStatus=='1'){
                                                                        html+='<a href="javascript:void(0)" onclick="tg(this)" data-id="'+rows[i].fpLog.id+'" act-type="1" class="btnGreen btnStyle">审核通过</a>';
                                                                    }
                                                                    if(rows[i].fpLog.checkStatus=='1'){
                                                                        html+='<a href="${pageContext.request.contextPath}/staff/fp_log/btg?id='+rows[i].fpLog.id+'" class="btnPayment btnStyle">审核不通过</a>';
                                                                        }
                                                                        html+='</td>';
                                                                        html+='</tr>';
                                                                    }
                                                        ...
                                                        function tg(e){
                                                            var r=confirm("确认审核通过该发票记录？");
                                                            if(r==true){
                                                                var id = $(e).attr("data-id");
                                                                $.ajax({
                                                                    type : 'get',
                                                                    url : "${pageContext.request.contextPath}/staff/fp_log/tg",
                                                                        data : {
                                                                            "id":id
                                                                        },
                                                                        success : function(result) {
