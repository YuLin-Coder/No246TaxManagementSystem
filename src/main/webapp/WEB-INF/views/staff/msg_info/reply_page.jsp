        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/jquery.min.js"></script>
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/global.js"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/jquery.tab.js"></script>
                    ...
                    <tr  id="replyContentParentContent">
                    <td align="right">回复内容</td>
                    <td >
                    <div style="width:720px;">  <textarea  placeholder="请输入回复内容"  id="replyContent"  rows="15" cols="100">${data.replyContent}</textarea>	<span style="color:red">*必填</span>
                        </div>
                        </td>
                        </tr>
                        ...
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                            ...
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0589"></script>
                                ...
                                function submitData(){
                                    ...
                                    $.ajax({
                                        type: 'post',
                                        url: '${pageContext.request.contextPath}/staff/msg_info/reply_submit',
                                            data:{
                                                "id":'${data.id}',
