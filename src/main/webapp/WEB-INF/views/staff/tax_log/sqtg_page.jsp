        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/jquery.min.js"></script>
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/global.js"></script>
                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/jquery.tab.js"></script>
                    ...
                    <td align="right">税务金额</td>
                    <td >
                    <div style="width:720px;">  <input type="text" class="inpMain" style="color:black;width:500px;"  placeholder="请输入税务金额（请输入数字）" id="taxAmount" />	<span style="color:red">*必填</span>
                    </div>
                    </td>
                    </tr>
                    
                    <tr  id="remarkParentContent">
                    <td align="right">税务说明</td>
                    <td >
                    <div style="width:720px;">  <textarea  placeholder="请输入税务说明"  id="remark"  rows="15" cols="100"></textarea>	<span style="color:red">*必填</span>
                    </div>
                    </td>
                    </tr>
                    ...
                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                        ...
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=6026"></script>
                            ...
                            function submitData(){
                                ...
                                $.ajax({
                                    type: 'post',
                                    url: '${pageContext.request.contextPath}/staff/tax_log/sqtg_submit',
                                        data:{
