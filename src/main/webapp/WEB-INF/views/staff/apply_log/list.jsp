            ...
            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                ...
                <c:forEach items="${taxTypeList}" var="item">
                    <option value="${item.id}">${item.name}</option>
                        ...
                        <div style="display:inline">
                        <p style="display:inline-block;margin-top:30px">
                        <span style="margin-left:20px;">主体类型</span>
                        <select  id="taxUserType" style="height:30px;color:black;width:250px;" >
                        <option value="">全部</option>
                                        ...
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/js/modal_js.js"></script>
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=6489"></script>
                                                            ...
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/selectSearch/jquery.searchableSelect.js?d=124393"></script>
                                                                ...
                                                                function ajaxList(page) {
                                                                    ...
                                                                    showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                        $.ajax({
                                                                            type : 'get',
                                                                            url : "${pageContext.request.contextPath}/staff/apply_log/queryList",
                                                                                data : {
                                                                                ...
                                                                                success : function(result) {
                                                                                    ...
                                                                                    for (var i = 0; i < rows.length; i++) {
                                                                                        ...
                                                                                        if(zjImgStr!=null){
                                                                                            ...
                                                                                            html+='<td>';
                                                                                            if(rows[i].applyLog.taxStatus=='1'){
                                                                                                html+='<a href="javascript:void(0)" data-url="${pageContext.request.contextPath}/staff/tax_log/sqtg?applyId='+rows[i].applyLog.id+'" page-name="报税记录" onclick="gotoPage(this)"  class="btnGreen btnStyle">审核通过</a>';
                                                                                                }
                                                                                                if(rows[i].applyLog.taxStatus=='1'){
                                                                                                    html+='<a href="${pageContext.request.contextPath}/staff/apply_log/btg?id='+rows[i].applyLog.id+'" class="btnPayment btnStyle">审核不通过</a>';
                                                                                                    }
                                                                                                    html+='</td>';
                                                                                                    html+='</tr>';
                                                                                                }
